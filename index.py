...
def download_lab(number_of_lab, number_of_variant, google_link, user_id):
    ...
    document.close()
    bot.send_message(user_id, "If you find a bug or know how to improve the code, write to <a href=\"tg://user?id=438890135\">us</a>. <b>Important!</b> Administration is not responsible for the wrong content. Everything that you download, you download only for informational purposes.", parse_mode = "HTML")
